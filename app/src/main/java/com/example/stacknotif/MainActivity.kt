...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        private const val CHANNEL_NAME = "yudha channel"
    ...
    private fun sendNotif() {
        ...
        val largeIcon = BitmapFactory.decodeResource(resources, R.drawable.ic_notifications_48_white)
        ...
        if (idNotification < MAX_NOTIFICATION) {
            mBuilder = NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setSmallIcon(R.drawable.ic_mail_48)
